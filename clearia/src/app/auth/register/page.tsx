    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-6">
      <div className='flex-col justify-center items-center'>
        ...
        <ul>
          ...
          <li><button onClick={() => router.push("/login/admin")} className='w-full font-normal! text-2xl! hover:cursor-pointer text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2'>Admin</button></li>
        ...
        <p className="mt-4">Don't have an account? <span onClick={() => router.push("/register")} className='text-blue-500 hover:cursor-pointer'>Register</span> </p>
      </div>
    </div>
  )
}
